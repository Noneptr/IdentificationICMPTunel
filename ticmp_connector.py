# /* ========================= Приципы построения ICMP пакетов для организации туннеля (конец файла) ===============================
import struct
import socket
import ipv4header
import icmpheader
...
# /* ================================================= Приципы построения ICMP пкетов в туннеле ===============================
#
#     Пример 1:
#
...
#     Пример 2:
#
#     тип = 3, код = 0 - 15 Destination Unreachable
#
#     +--------------+--------------+-----------------------------+
#     |     Type     |     Code     |           Checksum          |
#     +--------------+--------------+-----------------------------+
...
#     +-----------------------------------------------------------+    -----
#
#     * первый байт данных зарезервирован для валидности при передачи и должен быть равен 0x45;
#     * bytes_filler - байтовый заполнитель для выравнивания области данных пакета до 28 байт,
#       является случайной последовательностью байт;
#     * len_bfill - указывает какое количество байт заполнителя в пакете;
#
#     Пример 3:
#
#     тип = 5, код = 0-3 Redirect
#
#     +--------------+--------------+-----------------------------+
#     |     Type     |     Code     |           Checksum          |
#     +--------------+--------------+-----------------------------+
...
#     Пример 4:
#
#     тип = 13, код = 0 Timestamp Request
#
#     +--------------+--------------+-----------------------------+
#     |     Type     |     Code     |           Checksum          |
#     +--------------+--------------+-----------------------------+
...
#     Пример 5:
#
#     тип = 9, код = 0 Router Advertisement
#
#     +--------------+--------------+-----------------------------+
#     |     Type     |     Code     |           Checksum          |
#     +--------------+--------------+-----------------------------+
...
#     +-----------------------------------------------------------+    -----
#
#     bytes_filler - в данном случае байтовый заполнитель нужен для адресного выравнивания по 8 байт
#
#     Router Advertisement в поле данных несёт пары значений (Router Address[i], Preference level[i]),
#     где Router Address[i] для IPv4 4 байта, Preference level[i] - 4 байт;
#     AddrEntrySize = 2 - машиные слова для описания кортежа (Router Address[i], Preference level[i]);
#
#
#     Пример 6:
#
#     тип = 12, код = 0-2 Parameter Problem
#
#     +--------------+--------------+-----------------------------+
#     |     Type     |     Code     |           Checksum          |
#     +--------------+--------------+-----------------------------+
...
#     +-----------------------------------------------------------+    -----
#
#     в поле Pointer инкапсулируем 1 байт от ID
#
#
#
#     Пример 7:
#
#     тип = 17, код = 0 Address Mask Request
#
#     +--------------+--------------+-----------------------------+
#     |     Type     |     Code     |           Checksum          |
#     +--------------+--------------+-----------------------------+
...
#     +-----------------------------------------------------------+    -----
#
#     lenbfill поле включается в последний объект ifindex или ifaddr или ifname или mtu для которого понадобился заполнитель
#     для Data заполнитель не требуется. Для Data не требуется lenbfill, в заголовок ICPM добавлен атрибут Length
#     При туннелирование необходимо сначала по максимуму заполнить Extention Structure, а именно до 4 Interface Info Objects,
#     а уже на основе этого просчитывать размер данных в области дейтаграммы
#    ========================================================================================================================== */